...
public class PlayerControllerX : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        if (collision.gameObject.CompareTag("Enemy"))
        {
            ...
            Debug.Log("Colloded with " + collision.gameObject.name + " wtith powerup set to " + hasPowerup);
            ...
            else if (hasPowerup = false)// if no powerup, hit enemy with normal strength 
            {
